class VenuesController < ApplicationController
  def index
    ...
    @venues = @q.result(:distinct => true).includes(:dishes, :bookmark_dishes).page(params[:page]).per(10)
  ...
  def create
    ...
    @venue.dishes_id = params[:dishes_id]
    @venue.address_id = params[:address_id]
    @venue.neighborhoods_id = params[:neighborhoods_id]
